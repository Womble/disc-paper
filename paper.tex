...
\begin{figure}
 ...
 \caption{CASA simulation on the continuum emission of the model at 337GHz, using the same ALMA configuration as used for the molecular lines.}
 \label{continuum}
\end{figure}
