...
\begin{figure*}
 ...
 \caption{Integrated intesity maps for the simulated observations of:{\bf Top Left:} H$_2$CO 4$_{04}$\rightarow3$_{03}$, {\bf Top Right:}C$^{17}$O 3\rightarrow2, {\bf Bottom Left:} OCS 26\rightarrow25 and {\bf Bottom Right:} HCO$^+$ 3\rightarrow2. contours start at 3$\sigma$ and increasing in intervals of 3$\sigma$ for each of the maps except the H$_2$CO which starts at 5\sigma and increases in intervals of 5\sigma}
\end{figure*}
