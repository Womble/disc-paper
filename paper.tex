...
\begin{figure*}
 \includegraphics[width=168mm]{Figures/sim/imageOCS_26-25_30deg_composite_all.eps}
 \label{OCS_all}
...
\begin{figure*}
 \includegraphics[width=168mm]{Figures/sim/imageHCOp_3-2_30deg_all.eps}
 \label{hco+_all}
 \caption{HCO$^+$ 3-2 {\bf Left:} Continuum subtracted integrated intensity map, {\bf Right:} Intensity weighted velocity map}
\end{figure*}
